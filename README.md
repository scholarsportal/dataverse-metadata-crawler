...
3. [Commitlint](https://commitlint.js.org/): default [Conventional Commits](https://www.conventionalcommits.org/en/v1.0.0) rules is used. Commits that do not follow the rules will be rejected by the pre-commit hook ([Husky](https://typicode.github.io/husky/)).
